        ...
        <div class="search">
            <form id="search-form" action="{{route('st.subject.search')}}" method="GET">
                <div class="form-group">
                    <input name="subjectName_keyword" value="{{ old('subjectName_keyword') }}" id="subjectName_keyword"
                           class="form-control" type="text" placeholder="{{__('messages.subject_name')}}"/>
                </div>
                <div class="form-group">
                    <input name="departmentId_keyword" value="{{ old('departmentId_keyword') }}" id="departmentId_keyword"
                           class="form-control" type="text" placeholder="{{ __('messages.dep_id') }}"/>
                </div>
                <div class="form-group">
                    <input name="grades_keyword" value="{{ old('grades_keyword') }}" id="grades_keyword"
                           class="form-control" type="text" placeholder="{{ __('messages.grades') }}"/>
                </div>
                <div class="form-group">
                    <input name="status_keyword" value="{{ old('status_keyword') }}" id="status_keyword"
